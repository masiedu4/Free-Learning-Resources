  ...
  return (
    <footer class="mx-4">
      <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <Link target="_blank" href={"https://github.com/masiedu4/Free-Learning-Resources"} class="sm:flex sm:items-center sm:justify-between">
        ...
        <span class="flex justify-center gap-2 text-center text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2023{" "}
          <a href="https://twitter.com/MichaelAsiedu_" target="_blank" class="hover:underline">
